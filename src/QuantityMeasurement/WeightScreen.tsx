...
const WeightScreen = () => {
  ...
  return (
    <KeyboardAwareScrollView contentContainerStyle={styles.container}>
      <Image style={{ position: 'absolute', opacity: 0.1}} source={require('../Assets/weight.jpg')} />
      ...
      <View style={styles.pickerView}>
        <View style={styles.eachPicker}>
          ...
          <Picker selectedValue={fromUnit} style={styles.picker} onValueChange={(itemValue: WeightUnit) => setFromUnit(itemValue)}>
        ...
        <View style={styles.eachPicker}>
          ...
          <Picker selectedValue={toUnit} style={styles.picker} onValueChange={(itemValue: WeightUnit) => setToUnit(itemValue)}>
            <Picker.Item label="Grams" value="grams" />
            <Picker.Item label="Kilograms" value="kilograms" />
            <Picker.Item label="Pounds" value="pounds" />
            <Picker.Item label="Ounces" value="ounces" />
